...
let favoriteFoods = ['congee', 'ramen', 'tacos', 'pasta'];
...
console.log('Second animal is', animalArray[01])
...
console.log('Last animal is', animalArray.at(-1))
...
console.log('Removed first food');
console.log('The updated foods are', favoriteFoods);
// 4.e (STRETCH) TODO: Replace the second food in your array
//      with another one of your favorite foods.
//      Then log the updated array.
favoriteFoods=['congee', 'ramen', 'tacos', 'pasta'];
favoriteFoods.splice(1, 1,'tomatoes');
